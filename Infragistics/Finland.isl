...
<styleLibrary>
  ...
  <styleSets defaultStyleSet="Default">
    <styleSet name="Default" useOsThemes="False" useFlatMode="True">
      ...
      <styles>
        ...
        <style role="GridCaption">
          <states>
            <state name="Normal" backColor="WhiteSmoke" borderColor="Transparent" fontSize="11" backGradientStyle="None" backHatchStyle="None" />
          </states>
        </style>
        <style role="GridCell">
          <states>
        ...
        <style role="GridRow">
          <states>
            ...
            <state name="Active" foreColor="53, 53, 53" imageBackgroundStyle="Stretched" fontBold="True" imageBackgroundStretchMargins="3, 3, 3, 3">
              <resources>
                <name>Selected</name>
              </resources>
            </state>
    ...
    <styleSet name="TabStripStartPage" basedOn="TabStripPrimary">
      <styles>
        <style role="TabItemArea">
          <states>
            <state name="Normal" backColor="White" imageBackgroundStyle="Tiled" backGradientStyle="None" backHatchStyle="None" />
          </states>
        </style>
      </styles>
    </styleSet>
  ...
  <resources>
    ...
    <resource name="ToolbarBg" backColor="34, 89, 112" foreColor="White" imageBackgroundStyle="Stretched" foreColorDisabled="128, 160, 173" backGradientStyle="None" backHatchStyle="None" imageBackgroundStretchMargins="0, 3, 0, 3" />
